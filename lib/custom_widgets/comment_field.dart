...
class _CommentField extends State<CommentField>{
  ...
  void showComplaintUserDialog(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text((!SessionKeeper.user.authorities.contains(Authority.ADMIN))?"complain".tr():"Подать жалобу", style: TextStyle(color: Colors.black),),
            ),
            ...
            FlatButton(
                ...
                child: Text((!SessionKeeper.user.authorities.contains(Authority.ADMIN))?"complain".tr():"Подать жалобу",
                  style: TextStyle(
                      color: Colors.red,
                      fontSize: 16.0),
                )
    ...
    showDialog(context: context, builder: (BuildContext context) => banComplaintDialog);
                    ...
                    if(id!=SessionKeeper.user.id)Container(
                      ...
                      itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
                        ...
                        PopupMenuItem<String>(
                          ...
                          child: Container(
                              width: 120,
                              child:Text((!SessionKeeper.user.authorities.contains(Authority.ADMIN))?"complain".tr():"Подать жалобу",style: TextStyle(fontSize: 14),)),
                        ),
                         PopupMenuItem<String>(
                          height:25,
                          ...
                          child: Container(
                            width: 120,
                              child:Text((!SessionKeeper.user.authorities.contains(Authority.ADMIN))?"ban".tr():"Заблокировать",style: TextStyle(fontSize: 14),)),
                        ),
                         PopupMenuItem<String>(
                          height: 25,
                          value: "Delete",
